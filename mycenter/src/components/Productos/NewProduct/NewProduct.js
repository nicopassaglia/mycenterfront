...
class NewProduct extends Component{
  ...
  addProduct(event){
    ...
    if(this.state.nombre_producto === "" || this.state.dias_garantia === ""){
      ...
      let confirm = window.confirm("Esta por agregar un producto sin componentes, esta seguro?")
      if(!confirm){
        mandar = false;
      }
    }
  ...
  render(){
    return(
      <Aux>
        {this.state.redirect ? <Redirect to='/stock/' /> : ""}
        <Header />
        <div className="wrapper-newproduct">
          <form>
            <input type='text' name="nombre_producto" value={this.state.nombre_producto} placeholder="Nombre Producto" onChange={this.handleInputChange} /><br/>
            ...
            <select name="componente_actual_select" value={this.state.componente_actual_select} onChange={this.handleInputChange}>
              ...
              <button onClick={event => this.addComponent(event)}>Agregar componente a producto</button><br/>
              <hr/>
              ...
              <button onClick={event =>this.addProduct(event)}>Agregar Producto</button>
          </form>
        </div>
      </Aux>
    )
